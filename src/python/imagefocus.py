...
def processFile(imgdef):
    ...
    image4rectangles = os.path.join(projectDir, 'temp', 'img_exported', imgdef['fileName']) 
    # image2decorate   = os.path.join(projectDir, 'release', 'img', imgdef['fileName']) 

    rectangles = rr.getRectangles(image4rectangles)
    ...
    for area in imgdef['areas']:
        ...
        find_traverse_points(area_rectangles)
...
if __name__ == '__main__':
    ...
    print('DONE focus image part.py')